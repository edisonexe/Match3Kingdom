...
namespace Animations
{
    public class AnimationManager : IAnimation, IDisposable
    {
        ...
        public void MoveUI(GameObject target, Vector3 position, float duration, Ease ease)
        {
            target.GetComponent<RectTransform>().DOAnchorPos(position, duration).SetEase(ease);
        }
